...
# Extraer los primeros 6 componentes
pca_scores <- pca_result$x[, 1:6]

# Aplicar UMAP
set.seed(123)

umap_result <- umap(pca_scores)
...
ggplot(umap_df, aes(x = UMAP1, y = UMAP2)) +
  ...
  theme_minimal() +
  ggtitle("Proyección UMAP de las películas")
```


```{r}
umap_df$revenue <- df_numeric_clean$revenue

ggplot(umap_df, aes(x = UMAP1, y = UMAP2, color = revenue)) +
